...
const HomePage = () => {
  ...
  const initialValues = {
    // Define your form field values here
    // For example, if you have a field with name "email", you can initialize it like:
    name: '',
    email: '',
    phone: '',
    datetime: '',
  ...
  const submitForm = () => {
    <SweetAlert icon="success" title="Success" text="Form submitted successfully" onClick={handleButtonClick} />;
  };

  const SubmittedForm = Yup.object().shape({
    name: Yup.string().required('Please fill the Name'),
    email: Yup.string().email('Invalid email').required('Please fill the Email'),
    phone: Yup.string().required('Please fill the Phone number'),
    ...
    pinCode: Yup.string().required('Please provide a valid zip'),
  });
        ...
        <div className="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto">
          ...
          <div className="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-cta">
            <ul className="flex flex-col p-4 mt-4 font-medium border border-gray-100 rounded-lg md:p-0 bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
                <a href="#" className="block px-3 py-2 text-white bg-blue-700 rounded md:p-0 md:bg-transparent md:text-blue-700 md:dark:text-blue-500" aria-current="page">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <a
                  href="#"
                  className="block px-3 py-2 text-gray-900 rounded md:p-0 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 d:dark:hover:text-blue-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                >
                  Services
                </a>
              </li>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
          ...
          >
            ...
            <svg className="w-10 h-10 ml-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              <path
                fillRule="evenodd"
        ...
        <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-12">
          ...
          <div className="mt-10 space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
            <div className="flex flex-col items-center justify-center text-center">
              <div className="flex items-center justify-center w-10 h-10 mb-4 text-center bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-900">
              ...
              <h3 className="mb-2 text-2xl font-bold dark:text-white">Secure storage</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">Flowbite marketplace supports a variety of the most popular digital currencies. </p>
            </div>
            <div className="flex flex-col items-center justify-center text-center">
              <div className="flex items-center justify-center w-10 h-10 mb-4 text-center bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-900">
                <svg className="w-10 h-10 text-blue-600 lg:w-6 lg:h-6 dark:text-blue-300" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <path
                    fillRule="evenodd"
                    d="M3 3a1 1 0 000 2v8a2 2 0 002 2h2.586l-1.293 1.293a1 1 0 101.414 1.414L10 15.414l2.293 2.293a1 1 0 001.414-1.414L12.414 15H15a2 2 0 002-2V5a1 1 0 100-2H3zm11.707 4.707a1 1 0 00-1.414-1.414L10 9.586 8.707 8.293a1 1 0 00-1.414 0l-2 2a1 1 0 101.414 1.414L8 10.414l1.293 1.293a1 1 0 001.414 0l4-4z"
                    clipRule="evenodd"
              ...
              <h3 className="mb-2 text-2xl font-bold dark:text-white">Insurance</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">Flowbite marketplace supports a variety of the most popular digital currencies. </p>
            </div>
            <div className="flex flex-col items-center justify-center text-center">
              <div className="flex items-center justify-center w-10 h-10 mb-4 text-center bg-blue-100 rounded-full lg:h-12 lg:w-12 dark:bg-blue-900">
              ...
              <h3 className="mb-2 text-2xl font-bold dark:text-white">Best practices</h3>
              <p className="text-lg text-gray-500 dark:text-gray-400">Flowbite marketplace supports a variety of the most popular digital currencies. </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="flex items-center justify-center h-screen max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-12">
          <div className="w-full max-w-xl p-8 mt-8 bg-white rounded-md shadow-lg">
            <h2 className="text-2xl font-bold mb-8 text-[#07074D]">Book Appointment</h2>

            <Formik initialValues={initialValues} validationSchema={SubmittedForm} onSubmit={() => {}}>
              {() => (
                <Form>
                  <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
                    {/* Section 1: Personal Information */}
                    <div className="space-y-2">
                      <label className="text-base font-semibold text-[#07074D] sm:text-xl mt-4">Personal Information</label>
                      <Input name="name" label="Name" type="text" placeholder="John Doe" />
                      <Input name="phone" label="Phone Number" type="text" placeholder="+1-223-49489-388" />
                      <Input name="email" label="Email" type="email" placeholder="johndoe@gmail.com" />
                    </div>

                    {/* Section 2: Date and Time */}
                    <div className="space-y-2">
                      <label className="text-base font-semibold text-[#07074D] sm:text-xl mt-4">Booking Details</label>
                      <CustomDatePicker mode="date" initialValue={selectedDate} onChange={handleDateChange} label="Date" />
                      <CustomDatePicker mode="time" initialValue={selectedTime} onChange={handleTimeChange} label="Time" />
                    </div>
                  </div>

                  {/* Section 3: Address Details */}
                  <div className="space-y-2">
                    <label className="text-base font-semibold text-[#07074D] sm:text-xl mt-4">Address Details</label>
                    <Input name="address" label="Address" type="text" placeholder="H. No.: 123" />
                    <div className="grid grid-cols-1 gap-2 md:grid-cols-2">
                      <Input name="city" label="City" type="text" placeholder="California" />
                      <Input name="state" label="State" type="text" placeholder="San Jose" />
                    </div>
                    <Input name="postalCode" label="Postal Code" type="number" placeholder="788278" />
                  </div>

                  <button
                    type="submit"
                    onClick={submitForm}
                    className="w-full px-8 py-3 mt-8 text-base font-semibold text-center text-white bg-blue-600 rounded-md outline-none hover:shadow-form"
                  >
                    Book Appointment
                  </button>
                </Form>
